...
public class TestPlusAdvanced {
    ...
    public void setup() throws ContextualError {
        ...
        when(intexpr1.verifyExpr(compiler, null, null, null)).thenReturn(INT);
        when(intexpr2.verifyExpr(compiler, null, null, null)).thenReturn(INT);
        when(floatexpr1.verifyExpr(compiler, null, null, null)).thenReturn(FLOAT);
        when(floatexpr2.verifyExpr(compiler, null, null, null)).thenReturn(FLOAT);
    }
    ...
    public void testIntInt() throws ContextualError {
        ...
        // check the result
        assertTrue(t.verifyExpr(compiler, null, null, null).isInt());
        // check that the mocks have been called properly.
        verify(intexpr1).verifyExpr(compiler, null, null, null);
        verify(intexpr2).verifyExpr(compiler, null, null, null);
    }
    ...
    public void testIntFloat() throws ContextualError {
        ...
        // check the result
        assertTrue(t.verifyExpr(compiler, null, null, null).isFloat());
        ...
        // check that the mocks have been called properly.
        verify(intexpr1).verifyExpr(compiler, null, null, null);
        verify(floatexpr1).verifyExpr(compiler, null, null, null);
    }
