...
public class IncludeIncorrectException extends DecaRecognitionException {
    ...
    public IncludeIncorrectException(DecaLexer recognizer, IntStream stream, String expr_value) {
    ...
    public String getMessage() {
        return expr_value + ":[Syntax Error] Incorrect #include syntax: #include \"filename.decah\"";
    }
