...
public abstract class AbstractInst extends Tree {
    ...
    protected abstract void verifyInst(DecacCompiler compiler,
            EnvironmentExp localEnv, ClassDefinition currentClass, Type returnType, EnvironmentExp envTypes) throws ContextualError;
    ...
    /**
     * Generally the same as codeGenInst, except when it is overrided
     *
     * @param compiler
     */
