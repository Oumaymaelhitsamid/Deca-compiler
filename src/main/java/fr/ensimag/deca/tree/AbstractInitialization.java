...
public abstract class AbstractInitialization extends Tree {
    ...
    protected abstract void verifyInitialization(DecacCompiler compiler,
            Type t, EnvironmentExp localEnv, ClassDefinition currentClass, EnvironmentExp envTypes)
            throws ContextualError;

    protected abstract void codeGenInitialization(DecacCompiler compiler, DAddr dest);
    protected void codeGenClassInitialization(DecacCompiler compiler, DAddr dest){
        this.codeGenInitialization(compiler, dest);
    }
